...
parser.add_argument('--data_root_dir', type=str, default='/data_local2/ljjdata/TCGA/Patch-GCN/LUSC/', help='data directory')
parser.add_argument('--split_dir',       type=str, default='tcga_lusc', help='Which cancer type within ./splits/<which_splits> to use for training. Used synonymously for "task" (Default: tcga_blca_100)')
parser.add_argument('--bag_loss',        type=str, choices=['CELoss', 'CE+Loss', 'Cox','Cox+Loss'], default='CELoss', help='slide-level classification loss function (default: ce)')
parser.add_argument('--seed',            type=int, default=1, help='Random seed for reproducible experiment (default: 1)')
parser.add_argument('--k',               type=int, default=4, help='Number of folds (default: 5)')
parser.add_argument('--k_start',         type=int, default=-1, help='Start fold (Default: -1, last fold)')
parser.add_argument('--k_end',           type=int, default=-1, help='End fold (Default: -1, first fold)')
parser.add_argument('--results_dir',     type=str, default='./ljj_results-2022-10', help='Results directory (Default: ./results)')
parser.add_argument('--which_splits',    type=str, default='/data/project/TCGA/code/SUSTC/TMCNet/dataset_csv/', help='Which splits folder to use in ./splits/ (Default: ./splits/5foldcv')
...
args.split_dir = os.path.join( args.which_splits, args.split_dir.replace('tcga_',''))
